...
class ExhibitionFiltersDialog extends StatefulWidget {
  ExhibitionFiltersDialog(
      {super.key,
  ...
  @override
  State<ExhibitionFiltersDialog> createState() => _ExhibitionFiltersDialogState(
      sortBy: sortBy,
      epoch: epoch,
      type: type,
      artist: artist,
...
class _ExhibitionFiltersDialogState extends State<ExhibitionFiltersDialog> {
  String sortBy = 'Name A -> Z';
  String epoch = '';
  RangeValues yearRange = const RangeValues(1500, 2025);
  String type = '';
  String artist = '';
  _ExhibitionFiltersDialogState({
    required this.sortBy,
    required this.epoch,
    required this.type,
    required this.artist,
